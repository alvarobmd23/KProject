...
from .views import (Document_Type_Create, Document_Type_Delete,
                    ...
                    document_type_list, entrys_add, entrys_detail, entrys_list)
...
urlpatterns = [
    ...
    path('entrys/edit/<int:pk>/',
         login_required(Document_Type_Update.as_view()), name='entrys_edit'),
    path('entrys/delete/<int:pk>/',
         login_required(Document_Type_Delete.as_view()), name='entrys_delete'),
